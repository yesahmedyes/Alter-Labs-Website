...
export default function HeroSection() {
  ...
  return (
    <section id="home" className="h-screen bg-purple-50/30 w-full">
      <div className="absolute top-1/3 left-1/4 w-48 h-48 lg:w-100 lg:h-100 bg-green-300 opacity-40 blur-[100px] rounded-full -z-10"></div>
      ...
      <div className="flex flex-col items-center justify-center gap-8 text-center mx-auto h-[calc(100vh-20%)] lg:h-[calc(100vh-20%)] px-5">
        ...
        <div className="pt-8">
          <button
            ...
            className="bg-black text-white px-8 py-3 text-sm rounded-full border hover:bg-transparent cursor-pointer hover:text-black transition-all"
          >
            Get in touch
          </button>
        </div>
